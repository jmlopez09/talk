...
<!--  FORM START HERE   -->
                          ...
                          this fixex TABING in the Correct order   
                           -->
                            ...
                            <input tabindex="15" id="credit" name="credit" class="col-sm-12 col-md-5 col-lg-3 form_input credit checkboxes" type="checkbox" value="true" <?php if ($credit == 1) echo 'checked'; ?> >
                            </fieldset>
                            ...
                            <select tabindex="9" class="col-sm-12 col-md-5 col-lg-5 form_input" name="mWanted" id="mWanted" value = "<?php echo $mWanted; ?>" >
                            ...
                            <fieldset class="col-sm-12 col-md-5 col-lg-12 rightside">
                              ...
                              <input tabindex="20" id="activeBox" name="activeBox" class="col-sm-12 col-md-5 col-lg-3 form_input checkboxes" type="checkbox" value="true"  <?php if ($active == 1) echo 'checked'; ?>>
                            </fieldset>
...
-->
    ...
    <script>
      var majorobject  = document.getElementById('mWanted');
      var inputs = document.getElementsByClassName('form_input');
      var labels = document.getElementsByClassName('form_label');
      majorobject.addEventListener('mouseover',function(){
        this.setAttribute('multiple','multiple');
        
        
      });
      majorobject.addEventListener('mouseout',function(){
