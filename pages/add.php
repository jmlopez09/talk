...
/*
          ...
          /*
            ...
            foreach ($mWanted as $major) {
              echo '<option' . ($mWanted($id, $major) ? ' selected="selected"' : '') . '></option>';
            }
          }*/
          ...
          if ($validate == 0)
          {
           ...
           {
             $query = "INSERT INTO `internship2` (`ID`, `JobTitle`, `JobDescription`, `CompanyName`, `CompanyURL`, `DatePosted`, `DateExpired`, `SkillsNeeded`, `ApplicationInstructions`, `ContactPerson`, `ContactEmail`, `ContactPhone`, `Salary`, `WorkHours`, `Credit`, `CompanyDescription`, `Address`, `DegreeWanted`, `Active`) 
             VALUES 
             (NULL, '$job', '$desc ', '$company', '$cUrl', '$opendate', '$closedate', '$skills', '$appInst', '$contact', '$contEmail', '$contPhone', '$salary', '$time', '$credit', '$comdesc', '$cAddress', '$dWanted', '$active');";
...
<!--  FORM START HERE   -->
                          ...
                          this fixex TABING in the Correct order   
                           -->
                            ...
                            <input type="text" tabindex="4" name="company" id="company" class="col-sm-12 col-md-5 col-lg-5 form_input" value = "<?php echo $company; ?>"><span style="color:red" class="col-sm-12 col-md-5 col-lg-3 error"><?php echo $companyError;?></span> 
                            </fieldset>
                            ...
                            <input placeholder="www.broward.edu" tabindex="5" class="col-sm-12 col-md-5 col-lg-5 form_input" type="text" name="cUrl" id="cUrl" value = "<?php echo $cUrl; ?>"><span style="color:red" class="col-sm-12 col-md-5 col-lg-3 error"><?php echo $cUrlError?></span>
                            </fieldset>
                            <!--Tabindex 15 credit-->
                            <fieldset class="col-sm-12 col-md-5 col-lg-12 rightside">
                            <label for="credit" class="col-sm-12 col-md-5 col-lg-3 form_label">Credit</label>
                            <input tabindex="15" id="credit" name="credit" class="col-sm-12 col-md-5 col-lg-3 form_input checkboxes" type="checkbox" value="true" <?php if (isset($_POST['credit'])) echo 'checked'; ?>>
                            </fieldset>
                            ...
                            <input type="text" tabindex="10" class="col-sm-12 col-md-5 col-lg-5 form_input" name="contact" id="contact" value = "<?php echo $contact; ?>" ><span style="color:red" class="col-sm-12 col-md-5 col-lg-3 error"><?php echo $contactError;?></span> 
                              </fieldset>
                            
                            <!--Tabindex 20 active-->
                            <fieldset class="col-sm-12 col-md-5 col-lg-12 rightside">
                              <label for="activeBox" class="col-sm-12 col-md-5 col-lg-3 form_label">Active</label>
                              <input tabindex="20" id="activeBox" name ="active" class="col-sm-12 col-md-5 col-lg-3 form_input checkboxes" type="checkbox" value="true"  <?php if (isset($_POST['active'])) echo 'checked'; ?>>
                            </fieldset>
      ...
      <!--                      <label></label><textarea class="textarea" placeholder="This will hold something" disabled></textarea>-->
                            <div class="btncontainer">
                                ...
                                <input tabindex="22" id="resetbtn"  class="formbutton btn btn-default" type="Reset" value="Reset" onclick="<?php resetErrors();?>">
                            </div>
                          </form>
                        </div>
                      </div>
